import { c as create_ssr_component, b as add_attribute, e as escape, v as validate_component } from "./app-c055211a.js";
...
const Graph = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
  return `<div class="${"mt-4 h-56 rounded-xl bg-white p-7"}"><canvas height="${"224px"}"${add_attribute("this", canvas, 0)}></canvas></div>`;
});
const InfoCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"flex md:flex-col flex-row items-center bg-white rounded-xl p-8 auto md:w-64 md:h-56 md:mt-24 mt-4 flex-shrink-0 space-x-4 md:space-x-0"}"><div class="${"rounded-xl w-24 h-24 md:mx-auto p-7 bg-green-400 md:-mt-20"}"><img${add_attribute("src", `/img/icons/${icon}-solid.svg`, 0)}${add_attribute("alt", `logo for ${message}`, 0)} class="${""}"></div>
    <div class="${"flex md:flex-col items-center justify-between flex-grow md:flex-grow-0"}"><p class="${"text-lg font-semibold md:mt-8 text-white p-2 rounded-md bg-green-600 hover:bg-green-800"}">view
        </p>
        <p class="${"text-lg font-medium md:mt-4"}">${escape(message)}</p></div></div>

<div class="${[
    "m-0 fixed inset-0 flex justify-center items-center z-10 rounded-2xl",
    "hidden"
  ].join(" ").trim()}"><div class="${"fixed inset-0 bg-black bg-opacity-80"}"></div>
    <div class="${"bg-white z-20 p-7 w-5/12 rounded-xl"}"><h3 class="${"font-xl font-bold"}">${escape(message)}</h3>
        <div class="${"flex space-x-3 mt-3 items-center"}"><select class="${"p-2 rounded-md bg-white border-2 border-gray-300"}"><option value="${"0"}">Today</option><option value="${"1"}">This week</option><option value="${"2"}">This month</option><option value="${"3"}">This year</option><option value="${"4"}">All time</option></select>
            <div>${escape(data[selected])}</div></div>
        ${validate_component(Graph, "Graph").$$render($$result, {}, {}, {})}</div></div>`;
});
const Activity = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.time === void 0 && $$bindings.time && time !== void 0)
    $$bindings.time(time);
  return `<div class="${"flex items-center space-x-7"}"><div class="${"w-9 h-9 bg-yellow-600 rounded-full relative"}"></div>
    <div class="${"h-24 bg-white flex-grow rounded-lg flex justify-between items-center px-5"}"><p class="${"text-2xl font-medium"}">${escape(message)}</p>
        <p>${escape(time)} day${escape(time == 1 ? "" : "s")} ago</p></div></div>`;
});
const ActivityList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"space-y-10 rounded-xl mt-4 px-11 relative"}" style="${"max-width: 1144px;"}"><div class="${"bg-gray-400 w-3 rounded-2xl absolute inset-y-0 left-14"}"></div>
    ${validate_component(Activity, "Activity").$$render($$result, {
    message: "Donated $10 to Change Vietnam",
    time: "3"
  }, {}, {})}
    ${validate_component(Activity, "Activity").$$render($$result, { message: "Redeemed $5", time: "5" }, {}, {})}
    ${validate_component(Activity, "Activity").$$render($$result, {
    message: "Donated $15 to WWF",
    time: "10"
  }, {}, {})}</div>`;
});
const Seller = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div><div class="${"flex md:flex-row flex-col md:space-x-10 overflow-auto scroll"}">${validate_component(InfoCard, "InfoCard").$$render($$result, {
    data: [0, 12, 60, 96, 124],
    icon: "award",
    message: "Points",
    class: "bg-red-400"
    ...
    data: ["0 KG", "4 KG", " 24 KG", "44 KG", "66 KG"],
    icon: "trash",
    message: "Recycled"
  }, {}, {})}
    ${validate_component(InfoCard, "InfoCard").$$render($$result, {
...
<h1 class="${"text-2xl font-bold mt-10"}">Activity log</h1>
${validate_component(ActivityList, "ActivityList").$$render($$result, {}, {}, {})}</div>`;
});
