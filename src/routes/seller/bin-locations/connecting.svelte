<script>
    ...
    onMount(() => {
        setInterval(() => dotcount++, 1000);
        setTimeout(() => link.click(), 5000 + 5000 * Math.random());
    });
</script>
...
<div class="p-7 w-fit bg-white rounded-2xl mx-auto flex flex-col mt-10">
    ...
    <div class="mt-4 flex justify-between items-center">
        <p>Connecting{".".repeat(dotcount)}</p>
        <button
            class="p-3 bg-blue-600 hover:bg-blue-800 text-white font-bold rounded-md"
            href="https://www.google.com/maps/dir/2%2F19+Ph%E1%BA%A1m+V%C4%83n+B%E1%BA%A1ch,+Ph%C6%B0%E1%BB%9Dng+15,+T%C3%A2n+B%C3%ACnh,+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh/A75+%C4%90.+B%E1%BA%A1ch+%C4%90%E1%BA%B1ng,+Ph%C6%B0%E1%BB%9Dng+2,+T%C3%A2n+B%C3%ACnh,+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh/@10.8197605,106.6387357,14z/data=!3m1!4b1!4m14!4m13!1m5!1m1!1s0x31752966f7abb3e5:0x965e8833d2d98984!2m2!1d106.637801!2d10.817937!1m5!1m1!1s0x317529193724a1c5:0x4795b3f7e8f44068!2m2!1d106.669803!2d10.81642!3e0"
            on:click={() => showmap = true}
            >Locate</button
        >
    </div>
    <a
        href="/seller/bin-locations/connected"
        sveltekit:prefetch
        bind:this={link}
        hidden>_</a
    >
